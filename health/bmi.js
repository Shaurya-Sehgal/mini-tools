function check() {
  ...
  if (bmi < 18.5) {
    document.getElementById("result").innerHTML =
      "You Are Under-Weight, And Your Current BMI is: " + bmi;
    document.getElementById("result").style.color = "rgb(255, 95, 95)";
  } else if (bmi <= 24.9) {
    document.getElementById("result").innerHTML =
      "You Are Healthy, And Your Current BMI is: " + bmi;
    document.getElementById("result").style.color = "limegreen";
  } else if (bmi <= 29.9) {
    document.getElementById("result").innerHTML =
      "You Are Over-Weight, And Your Current BMI is: " + bmi;
    document.getElementById("result").style.color = "red";
  } else if (bmi <= 34.9) {
    document.getElementById("result").innerHTML =
      "You Are Obese, And Your Current BMI is: " + bmi;
    document.getElementById("result").style.color = "darkred";
  } else if (bmi >= 35) {
    document.getElementById("result").innerHTML =
      "You Are Sevearly Obese, And Your Current BMI is: " + bmi;
